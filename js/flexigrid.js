	...
	$.addFlex = function(t,p)
	{
		...
		var g = {
			...
			doSearch: function () {
				...
				p.newp = 1;
				if(p.url.indexOf(".json") >-1){
					alert("This grid supports server side filtering only");
					return false;
				}
				this.populate();				
			},
		...
		if (p.title)
		{
			...
			if (p.showTableToggleBtn)
				{
					$(g.mDiv).append('<div class="ptogtitle" title="Minimize/Maximize Table"><span name="gridToggleButton"></span></div>');
